...
Here's an example from the excellent [taxi repo](https://github.com/fpganinja/taxi/) of SV components (I'd highly recommend this repo if your project needs ethernet):
